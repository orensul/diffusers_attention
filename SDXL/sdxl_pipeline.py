...
from SDXL.attention_store import AttentionStore
from SDXL.attention_processor import AttnStoreAttnProcessor, SelfAttnProcessor2_0
...
class AttentionStableDiffusionXLPipeline(StableDiffusionXLPipeline):
    ...
    def register_attention_processors(self):
        ...
        for i, name in enumerate(self.unet.attn_processors.keys()):
            ...
            if is_cross_attn:
                attn_procs[name] = AttnStoreAttnProcessor(
                    attnstore=self.attention_store, place_in_unet=place_in_unet
                )
            else:
                attn_procs[name] = SelfAttnProcessor2_0()
    ...
    def __call__(
        ...
        **kwargs,
        ...
        self.attention_store = AttentionStore(save_attn_res=32)
        ...
        with self.progress_bar(total=num_inference_steps) as progress_bar:
            for i, t in enumerate(timesteps):
                ...
                self._cross_attention_kwargs["step_index"] = i
